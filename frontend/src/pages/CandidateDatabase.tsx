...
function CandidateDetailModal({
  ...
  const detail = apiData.candidate_detail || candidate?.candidate_detail || {};
  ...
  const parsedField = (key: string, ...fallbackValues: any[]) => firstAvailable(parsedCV[key], detail[key], apiData[key], candidate?.[key], ...fallbackValues);
