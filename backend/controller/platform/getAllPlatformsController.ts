...
const getAllPlatformsController = express.Router();
...
getAllPlatformsController.get("",
  ...
  async (req, res) => {
    ...
    const result = await withTransaction(async (pool) => {
      return await Platform.getAll({ page, limit, unlimited, search }, pool);
    });
...
export default getAllPlatformsController;
